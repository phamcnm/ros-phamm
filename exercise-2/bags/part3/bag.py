...
bag_location = "/home/roboticslab229l/Documents/ros-phamm/exercise-2/bags/part3/move.bag"
...
for i in range(len(point_list)):
    ...
    yr = 0
    thetar = 0.0318 * point_list[i][2] / (2 * 0.018 * 0.7) - 0.0318 * point_list[i][1] / (2 * 0.018 * 0.66)
